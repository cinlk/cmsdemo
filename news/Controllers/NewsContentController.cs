...
using news.Models;
using news.Controllers.ResponseModel;
    ...
    public class NewsContentController : Controller
    {
        ...
        public async Task<JsonResult> AllNews()
        {
            ...
            try
            {
                ...
                var all = await _dbCon.ml.QueryAsync<DocumentResponseModel>("select nm.Id, nm.Content from Document as nm  " +
                    "inner join " +
        ...
        public async Task<JsonResult> OneNews(string id)
        {
            ...
            try
            {
                ...
                var first = await _dbCon.ml.QueryFirstAsync<DocumentResponseModel>("select id, " +
